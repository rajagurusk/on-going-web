  ...
  return (
    <Box width={"100%"} height={"100%"} marginTop={"5rem"}>
      <VStack width={["90%", "90%", "90%", "50%"]} height={"100%"} margin={"auto"}>
        ...
        <Text letterSpacing={"2px"}>New User? Register Here</Text>
        ...
        >
          ...
          {/* Password */}
          <VStack width={"70%"} height={"100%"} alignItems={"flex-start"} gap={"1rem"}>
          ...
          {/* Display Go to Login Button after successful sign-up */}
          {signUpSuccess && (
            <HStack width={"100%"} justifyContent={"center"} alignItems={"center"} textAlign={"center"}>
              <Link to="/login">
                <Button
                  width={"40%"}
                  bg={'#5EA98B'}
